...
class Header(models.Model):
    ...
    image_hyperlink = models.URLField(
        _('Image_Hyperlink'),
        null = True,
        blank = True,
    )
...
class Head(models.Model):
    product = models.ForeignKey(Product,on_delete = models.SET_NULL,related_name = 'head_product',null = True, blank = True)
    menu = models.CharField(_("Menu"), max_length = 100,null = True, blank = True)
    hyperlink = models.URLField(_('Hyperlink'), null = True, blank = True)

    @property
    def sys_id(self):
        return "H{}".format(str(self.pk + 1000).zfill(6))
