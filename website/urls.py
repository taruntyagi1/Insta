...
from website.views import (
  ...
  NewFaqView,NewReturnPolicyView,NewTermsOfUseView, NewPrivacyPolicyView,NewShippingPolicyView,NewProductDetailsView
)
...
urlpatterns = [
  ...
  path("defficiency-report/<int:pk>/thankyou", DeffieicencyReportView.as_view(), name='defficiency_report'),
